...
1000, and is no better for it. The basin of good constants is wide. The two failures are not
a wrong λ but a bad path to it.
...
sensible λ. I re-ran it on 4 September 2026 on a MacBook Air, CPU, PyTorch 2.9.1: a sweep
